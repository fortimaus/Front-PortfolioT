<template>
  <div class="modal fade" id="updateRepoModal" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="mb-3">
              <label for="achievementLanguage" class="form-label"> Язык программирования/Технологии</label>
              <textarea 
                class="form-control" 
                id="achievementLanguage" 
                v-model="form.language"
                rows="4"
                required
                placeholder="Опишите языки программирования, используемые технологии и т.д."
              ></textarea>
            </div>
...
export default {
  ...
  mounted() {
    this.modalInstance = new Modal(document.getElementById('updateRepoModal'))
  },
  methods: {
    async show(id) {
      this.resetForm()
